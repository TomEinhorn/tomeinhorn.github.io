...
Beyond the dissertation, I am involved in several projects that bring computational social science approaches to political and comparative-historical sociology. One uses natural language inference to trace the history of settler colonialism in Canadian law, regulation, and legislation from the nineteenth century to the present. Another asks what large language models "know" about history and whether we can use LLMs to represent the past.
